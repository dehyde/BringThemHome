...
class TimelineCore {
    ...
    calculateDimensions() {
        ...
        this.dimensions = {
            ...
            width: Math.max(rect.width - this.config.margins.left - this.config.margins.right, 600),
            height: Math.max(rect.height - this.config.margins.top - this.config.margins.bottom, 400)
        };
